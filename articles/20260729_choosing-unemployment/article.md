---
title: "Choosing Unemployment over a Secure Software Engineering Job"
description: "A story of what led me to resignation."
tags: ["work"]
---
...
I chose to quit without any backups. Without any ongoing job applications. Without any anything. Everyone told me that I was out of my mind. Me, someone who always had a backup plan for a backup plan. Decided to quit my high paying stable income.
...
I applied here because I saw that they are looking for humans. Actual humans, not just a thing procured by the HRs. Someone who had their own opinions, could throw in random ideas, someone who had their own ideals, and most importantly, someone who had their own past.

Everyone is unique. I like listening to other people's stories because, I get to learn more about them. About their journey, their struggles, their questions, their motivations, their opinions, their past, their dreams, their everything. Humans are unique. People are unique.
...
My planning took a lot more time than implementing. I implemented everything using the SDD framework. Iterating the plan with AI took a lot more time and a ton of tokens before it is ready to be implemented. Even I review **all lines of code** during the implementation. Whether it were the unit test files that people don't bother to care, or docstrings.

Even during reviewing other Pull Requests, I tried reading all lines. Whether it was a 400+ LoC or 7000+ LoC, I read them all. Including the tests files. I flag everything suspicious. Go through the files again. Then finally ask for AI to help review. This way, I learn how the majority of the code works and I had the context when I read the AI's summary.

Again, this kind of "ideal" workflow was taking more time than my peers. But, most of my work was flawless and has minimal bugs. And, I was using AI in a way that _I_ learn too. I don't want to brainlessly throw everything into AI. I don't want to build a habit of early gratification with AI. 
